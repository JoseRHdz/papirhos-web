  	...
  	<div class="row">
    	...
    	<div class="col align-self-center">
    			...
    			<div class="input-group">
    				<div class="input-group-prepend">
      				<span class="input-group-text" id="basic-addon0"><i class="fas fa-feather"></i></span>
      			</div>
      		<input id="search" type="text" class="form-control" placeholder="Buscar Autor..." aria-label="search" aria-describedby="basic-addon1">
    				<div class="input-group-prepend">
    	...
    	<div class="col align-self-end">
				<div class="text-right">
					<button onclick="location.href='newAutor.php';" type="button" title="Nuevo Autor" class="btn btn-light btn-sm"><i class="fas fa-user-plus"></i></button>
				</div>
  		</div>
	</div>
		...
		<table class="table table-striped table-light table-bordered table-hover" id="table">
			...
			<tfoot class="table-dark">
				<tr>
      		<th colspan="4" class="ts-pager bg-info">
...
<script src="searchAutor.js"></script>
</body>
</html>
